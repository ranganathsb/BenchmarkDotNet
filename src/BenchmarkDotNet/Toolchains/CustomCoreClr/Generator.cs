...
namespace BenchmarkDotNet.Toolchains.CustomCoreClr
{
    ...
    public class Generator : CsProjGenerator
    {
        ...
        internal Generator(string coreClrVersion, string coreFxVersion, string targetFrameworkMoniker, string runtimeIdentifier, IReadOnlyDictionary<string, string> feeds, bool useNuGetClearTag, bool useTempFolderForRestore)
            : base(targetFrameworkMoniker, platfrom => platfrom.ToConfig())
        {
