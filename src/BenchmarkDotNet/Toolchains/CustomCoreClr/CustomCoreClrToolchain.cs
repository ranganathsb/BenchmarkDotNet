...
namespace BenchmarkDotNet.Toolchains.CustomCoreClr
{
    ...
    {
        internal CustomCoreClrToolchain(string displayName, string coreClrVersion, string coreFxVersion, 
    ...
    public class CustomCoreClrToolchainBuilder
    {
        ...
        /// <summary>
        /// tells the toolchain to use the default CoreClr (for given dotnet cli and moniker)
        /// </summary>
        ...
        /// <summary>
        /// tells the toolchain to use the default CoreFx (for given dotnet cli and moniker)
        /// </summary>
        ...
        /// <param name="runtimeIdentifier">if not provided, the one from PATH will be used</param>
        ...
        /// <summary>
        /// restore to temp folder to keep your CI clean or install same package many times (perhaps with different content but same version number)
